...
//
function sendPollGrupo($params, $body)
{
    checkParameter::sendPoll($params, $body);
    checkToken::validateToken($params, $body);
    $SessionName = $body->SessionName ?? null;
    $groupId = $body->groupId ?? null;
    $name = $body->name ?? null;
    $selectableCount = $body->selectableCount ?? null;
...
//
$router->post('/sendPollGrupo', function ($params, $body) {
    sendPollGrupo($params, $body);
});
