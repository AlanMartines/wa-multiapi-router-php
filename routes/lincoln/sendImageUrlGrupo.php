...
//
function sendImageUrlGrupo($params, $body)
{
    checkParameter::sendImageUrl($params, $body);
...
//
$router->post('/sendImageUrlGrupo', function ($params, $body) {
    sendImageUrlGrupo($params, $body);
});
