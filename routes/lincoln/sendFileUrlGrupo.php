...
//
function sendFileUrlGrupo($params, $body)
{
    checkParameter::sendFileUrl($params, $body);
    ...
    $apiUrl = APIURLBND;
    $apiUrlRequest = $apiUrl . '/message/sendurlfile?key=' . trim($SessionName);
    //
    $mimeType = checkParameter::mimeTypeUrlFile($params, $body);
    $mime = null;
    switch (true) {
...
//
$router->post('/sendFileUrlGrupo', function ($params, $body) {
    sendFileUrlGrupo($params, $body);
});
