...
//
function setPictureGroup($params, $body)
{
    ...
    $apiUrl = APIURLBND;
    $apiUrlRequest = $apiUrl . '/misc/updateProfilePicture?key=' . trim($SessionName);
    //
...
//
$router->post('/SetPictureGroup', function ($params, $body) {
    setPictureGroup($params, $body);
});
//
$router->post('/setPictureGroup', function ($params, $body) {
    setPictureGroup($params, $body);
