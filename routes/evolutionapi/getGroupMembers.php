...
//
function getGroupMembers($params, $body)
{
    ...
    $apiUrl = APIURLBND;
    $apiUrlRequest = $apiUrl . '/group/groupidinfo?key=' . trim($SessionName);
    //
    //
    $config = [
    ...
    if (!empty($responseData->error)) {
        ...
        $result = [
            ...
            "groupMembers" => $responseData->data->participants
        ];
    }
...
//
$router->post('/getGroupMembers', function ($params, $body) {
    getGroupMembers($params, $body);
});
