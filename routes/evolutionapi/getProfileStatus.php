...
//
function getProfileStatus($params, $body)
{
    ...
    $apiUrl = APIURLBND;
    $apiUrlRequest = $apiUrl . '/misc/getStatus?key=' . trim($SessionName);
    //
    $config = [
    ...
    if (!empty($responseData->error)) {
        ...
        $isoDate = $responseData->data->setAt;
...
//
$router->post('/getProfileStatus', function ($params, $body) {
    getProfileStatus($params, $body);
});
//
$router->post('/getProfileStatus', function ($params, $body) {
    getProfileStatus($params, $body);
