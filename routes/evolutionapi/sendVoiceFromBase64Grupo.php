...
//
function sendVoiceFromBase64Grupo($params, $body)
{
    checkParameter::sendVoiceBase64($params, $body);
...
//
$router->post('/sendVoiceFromBase64Grupo', function ($params, $body) {
    sendVoiceFromBase64Grupo($params, $body);
});
