...
//
function sendImageFromBase64Grupo($params, $body)
{
    ...
    if (!$mimetype || !str_starts_with($mimetype, 'image/')) {
        ...
        echo json_encode([
            "Status" => [
                ...
                "message" => "Arquivo selecionado não permitido, apenas arquivo de image"
            ]
        ]);
        exit;
    }
...
//
$router->post('/sendImageFromBase64Grupo', function ($params, $body) {
    sendImageFromBase64Grupo($params, $body);
});
